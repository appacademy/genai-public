...
class OllamaClient:
    ...
    def __init__(self, api_url: Optional[str] = None, model: str = "gemma3:4b"):
        ...
        if not self.api_url:
            raise ValueError("Ollama API URL not provided and OLLAMA_API_URL environment variable not set")
        self.model = model
    ...
    def generate(self, prompt: str, temperature: float = 0.8, stream: bool = False, 
                 model: Optional[str] = None) -> Union[Dict[str, Any], Iterator[Dict[str, Any]]]:
        """
